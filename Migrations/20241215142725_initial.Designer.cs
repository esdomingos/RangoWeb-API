...
namespace RangoWeb.API.Migrations
{
    ...
    [Migration("20241215142725_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RangoWeb.API.Entities.Ingredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("RangoWeb.API.Entities.Rango", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("IngredientRango", b =>
                {
                    b.HasOne("RangoWeb.API.Entities.Ingredient", null)
                        .WithMany()
                        .HasForeignKey("IngredientesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RangoWeb.API.Entities.Rango", null)
                        .WithMany()
